...
export const MusicBillId = () => {
  ...
  return (
    <div className="flex flex-col justify-center">
      ...
      <div onClick={handleMoreButtonClick} className="container border w-[520px] h-62 cursor-pointer hover:bg-[#313131]">
        <div className="flex pl-10 mb-16">
          ...
          <button
            className="moreCircle h-44 z-[1] relative top-8 left-208"
